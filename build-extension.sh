...
zip -r screenbreak-extension-firefox.zip manifest.json common extension lib _locales

jq "del(.browser_specific_settings,.permissions[1],.options_ui.browser_style)" manifest.copy.json > manifest.json
zip -r screenbreak-extension-chromium.zip manifest.json common extension lib _locales

jq "del(.browser_specific_settings,.permissions[1],.options_ui.browser_style)" manifest.copy.json > manifest.json
zip -r screenbreak-extension-edge.zip manifest.json common extension lib _locales
